    ...
    <main style={{minHeight:'100vh',background:C.bg,paddingBottom:120,maxWidth:560,margin:'0 auto',fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif'}}>
      ...
      <div style={{background:`linear-gradient(160deg,${C.blueSoft} 0%,${C.white} 100%)`,padding:'40px 24px 32px',textAlign:'center',borderBottom:`1px solid ${C.border}`}}>
        <div style={{display:'flex',justifyContent:'center',marginBottom:20}}>
          <img src="/logo-purple.png" alt="We The People 39120" style={{height:200,objectFit:'contain',filter:'brightness(0) saturate(100%) invert(28%) sepia(89%) saturate(1000%) hue-rotate(195deg) brightness(90%) contrast(95%)'}} />
        </div>
        ...
        <p style={{fontSize:16,color:C.textSub,lineHeight:1.65,marginBottom:24}}>
          Connecting Natchez residents directly with their elected officials — so neighborhood problems get seen, tracked, and resolved.
        </p>
      ...
      <div style={{margin:'0 20px 24px',padding:'20px 22px',background:C.white,borderRadius:16,border:`1px solid ${C.border}`}}>
        ...
        <p style={{fontSize:15,lineHeight:1.75,color:C.textSub,marginBottom:12}}>
          For too long, a gap has existed between Natchez residents and the officials they elected to serve them. Calls went to voicemail. Reports submitted through the City's website disappeared — no follow-up, no confirmation, no accountability.
        </p>
        <p style={{fontSize:15,lineHeight:1.75,color:C.textSub,marginBottom:12}}>
          <strong style={{color:C.textMain}}>We The People 39120 bridges that gap.</strong> It doesn't replace city government — it empowers it. When residents report publicly and officials respond publicly, trust is built, problems get solved, and Natchez moves forward together.
        </p>
        <p style={{fontSize:15,lineHeight:1.75,color:C.textSub,marginBottom:16}}>
          It's easy to complain — we've all done it. But complaining alone changes nothing. Instead of pointing fingers at the elected official of the moment, let's try something different: let's work <em>with</em> them. We elected them because we believed in them. Now let's help them do their jobs better. Civic change is not just the government's responsibility — it's ours too. This platform is our contribution. <strong style={{color:C.blue}}>Together, we can make Natchez better.</strong>
        </p>
